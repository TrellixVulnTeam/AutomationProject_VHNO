...
class Chrome_Page(System):
    ...
    def start_chrome(self):
        logger.info("function:" + sys._getframe().f_code.co_name + ":启动chrome app:")
        self.device.start_app("com.android.chrome")
        sleep(1)

    def stop_chrome(self):
        logger.info("function:" + sys._getframe().f_code.co_name + ":关闭chrome app:")
        sleep(1)
    ...
    def enter_website(self, website="www.baidu.com"):
        try:
            logger.info("function:" + sys._getframe().f_code.co_name + ":进入网页{}:".format(website))
            ...
            logger.info("function:" + sys._getframe().f_code.co_name + ":成功进入网页{}:".format(website))
            try:
    ...
    def download_baidu_image(self):
        logger.info("function:" + sys._getframe().f_code.co_name + ":下载百度首页图片:")
    ...
    def get_first_download_file(self):
        logger.info("function:" + sys._getframe().f_code.co_name + ":获取下载记录中第一个文件number:")
    ...
    def save_bookmark(self, website="www.baidu.com"):
        logger.info("function:" + sys._getframe().f_code.co_name + ":保存{}为书签:".format(website))
